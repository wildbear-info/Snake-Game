...
def gameloop():
    ...
    while not exit_game:
        if game_over:
            ...
            text_screen('''Game Over! Press Enter To Continue''', pink, 100, 250)
            ...
            text_screen("Score: " + str(score * 10), lite, 5, 5)
            pygame.draw.rect(gameWindow, lite, [food_x, food_y, snake_size, snake_size])
            pygame.draw.line(gameWindow, lite, (0,40), (900,40),5)
